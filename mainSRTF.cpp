...
bool compareRemainingTimeSRTF(const MemoryBlock& a, const MemoryBlock& b) {
    return a.process.remainingTime < b.process.remainingTime;
}
bool compareArrivalTimeSRTF(const Process& a, const Process& b) {
...
int mainSRTF() {
    ...
    std::sort(processList.begin(), processList.end(), compareArrivalTimeSRTF);
